...
export const WeddingInvitationPage = () => {
  ...
  const guessCount= useWeddingBoundStore(state => state.guestCount)
  const setGuessCount= useWeddingBoundStore(state => state.setGuesCount)
  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>)=>{
    ...
    console.log({firstName,lastName,guessCount, isConfirmed, eventDate})
  }
